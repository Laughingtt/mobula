...
from arch.abc import CTableABC
# from arch.common import log, hdfs_utils, hive_utils
from arch.common import log
from arch.common.profile import computing_profile
from arch.computing.spark._materialize import materialize, unmaterialize
...
class Table(CTableABC):
    ...
    def save(self, address, partitions, schema, **kwargs):
        from arch.common.address import HDFSAddress
        ...
        from arch.common.address import HiveAddress, LinkisHiveAddress
        ...
        from arch.common.address import LocalFSAddress
